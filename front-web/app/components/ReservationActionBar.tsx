...
export function ReservationActionBar({
    ...
    return (
        <div
            ref={barRef}
            className="fixed inset-x-3 bottom-3 z-50 mx-auto flex max-w-[calc(100vw-24px)] items-center gap-2 rounded-app border border-border bg-secondary/95 px-3 py-3 shadow-2xl backdrop-blur sm:sticky sm:bottom-6 sm:mt-10 sm:w-fit sm:max-w-none sm:gap-4 sm:bg-secondary sm:px-5"
        >
                    ...
                    return (
                        <div
                            ...
                            className={`h-8 w-8 shrink-0 items-center justify-center rounded-app text-[9px] font-black ${
                                seat
                                    ? 'flex bg-foreground text-background'
                                    : 'hidden sm:flex bg-border/30 text-transparent'
                            }`}
                        >
            ...
            {totalPrice !== undefined && (
                <>
                    ...
                    <div className="shrink-0">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase leading-none mb-1 whitespace-nowrap">
                            合計金額
                        </p>
            ...
            <Button
                size="lg"
                className="h-10 shrink-0 whitespace-nowrap px-4 text-base font-black sm:px-10"
                onClick={onNext}
            >
                {nextLabel}
            </Button>
