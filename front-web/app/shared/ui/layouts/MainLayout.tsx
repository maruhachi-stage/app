      ...
      {pageInfo && (
        <div className="border-b border-border bg-muted/30">
          <div className="container-center py-8">
            <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-primary">HAL Cinema</p>
            <h1 className="mt-1 text-4xl font-black tracking-tight text-foreground">{pageInfo.title}</h1>
            {pageInfo.subtitle && <p className="mt-1 text-sm text-muted-foreground font-medium">{pageInfo.subtitle}</p>}
