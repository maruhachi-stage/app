                    ...
                    {days.map((day, index) => {
                        ...
                        return (
                            <div
                                ...
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter' || e.key === ' ') onSelect(day.iso)
                                }}
                            ...
                            >
                                <span
                                    className={`text-[10px] font-bold ${isActive ? 'text-primary-foreground/70' : 'text-muted-foreground'}`}
                                >
                                    {labelText || ' '}
                                </span>
                                <span
                                    className={`text-xl font-black ${isActive ? 'text-primary-foreground' : 'text-foreground'}`}
                                >
                                    {dayNum}
                                </span>
                                <span
