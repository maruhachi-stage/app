...
const NEWS_ITEMS: NewsItem[] = [
    {
        ...
        description:
            'アクリルスタンド・クリアファイル・Tシャツなど全12種類。劇場ショップにて販売中。',
        date: '2025-06-01',
        isNew: true,
    },
    {
        ...
        <section>
            ...
            <div className="divide-y divide-border rounded-lg border border-border overflow-hidden">
                {NEWS_ITEMS.map((item) => (
                    ...
                    >
                        <span
                            className={`shrink-0 mt-0.5 text-[10px] font-bold text-white px-2 py-0.5 rounded-sm ${CATEGORY_COLOR[item.category]}`}
                        >
...
export default function Home() {
    const { movies, todayScreenings, loading, error, todayStr, hasTodaySchedules } =
        useHomeScreenings()
            ...
            <div className="py-10 space-y-14">
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <Link
                            to={moviesListPath({ date: todayStr })}
