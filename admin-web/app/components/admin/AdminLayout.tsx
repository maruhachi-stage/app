...
export function AdminLayout() {
  const access = useEditAccess(); const { mode, setMode } = useThemeMode(); const [collapsed, setCollapsed] = useState(false)
  return <main className="admin-layout" data-sidebar-collapsed={collapsed}>
