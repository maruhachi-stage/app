        ...
        <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_280px] md:items-center">
          <div className="flex gap-4">
            ...
            <div className="min-w-0">
              <h1 className="text-2xl font-black tracking-tight">カートに入れました</h1>
              {addedItem ? (
                <div className="mt-3 flex gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">数量 {addedItem.quantity}</p>
                  </div>
                </div>
              ) : (
                <p className="mt-2 text-sm text-muted-foreground">商品をカートに追加しました。</p>
              )}
            </div>
          </div>
