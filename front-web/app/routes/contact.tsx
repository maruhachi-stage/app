...
export default function Contact() {
    return (
        <div className="py-16 max-w-2xl mx-auto">
            ...
            <div className="bg-card rounded-app border border-border p-8 shadow-sm">
                ...
                <form className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            className="w-full min-h-[150px] rounded-app border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-app border border-border bg-card/50">
                ...
                <div className="p-6 rounded-app border border-border bg-card/50">
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        className="mt-4 font-bold p-0 h-auto hover:bg-transparent text-primary underline-offset-4 hover:underline"
                    >
                        FAQを見る
                    </Button>
                </div>
