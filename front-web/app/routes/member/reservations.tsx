                        ...
                        >
                            <div className="h-32 w-24 shrink-0 overflow-hidden rounded-app bg-muted">
                                {res.thumbnailUrl ? (
                                    ...
                                    <div className="flex h-full items-center justify-center text-[10px] font-bold text-muted-foreground uppercase">
                                        No Image
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="flex flex-1 flex-col justify-between py-1">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[10px] font-bold text-muted-foreground">
                                            注文番号: {res.reservationCode}
                                        </span>
                                    </div>
                                    <h2 className="mt-2 text-lg font-black text-foreground line-clamp-1">
                                        {res.movieTitle}
                                    </h2>
                                ...
                                <div className="flex items-baseline justify-between">
                                    <span className="text-xs text-muted-foreground">
                                        {new Date(res.createdAt).toLocaleDateString()} 予約
                                    </span>
