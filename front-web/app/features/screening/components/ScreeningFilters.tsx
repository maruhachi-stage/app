        ...
        <div className="mb-8 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                ...
                <div className="flex items-center gap-3 text-sm">
                    <span className="hidden sm:inline text-muted-foreground font-bold">
                        並び替え
                    </span>
            ...
            <div className="flex items-center gap-3 rounded-app bg-muted/60 p-3 sm:p-4 border border-border">
                ...
                <div className="flex items-center gap-1 rounded-app border border-border bg-background p-1">
                    <button
                        ...
                        className={`rounded-app p-1.5 transition ${view === 'grid' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:bg-muted'}`}
                    >
                        <svg
                            className="h-5 w-5"
                            fill="none"
                    ...
                    <button
                        ...
                        className={`rounded-app p-1.5 transition ${view === 'list' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:bg-muted'}`}
                    >
                        <svg
                            className="h-5 w-5"
                            fill="none"
                    ...
                    <button
                        ...
                        className={`rounded-app p-1.5 transition ${view === 'timetable' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:bg-muted'}`}
                    >
                        <svg
                            className="h-5 w-5"
                            fill="none"
