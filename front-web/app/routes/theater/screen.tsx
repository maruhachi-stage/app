    ...
    return (
        <div className="max-w-3xl mx-auto py-10">
            ...
            <div className="flex flex-wrap items-end gap-3 mb-6">
                ...
                <span
                    className={`px-3 py-1 rounded border text-xs font-bold uppercase tracking-wider ${sizeStyles[screen.size]}`}
                >
                    {sizeLabels[screen.size]}
                </span>
                <span className="text-muted-foreground text-sm ml-auto">
                    全 <span className="font-bold text-foreground">{screen.totalSeats}</span> 席
                </span>
            </div>
            ...
            <div className="rounded-app border border-border overflow-hidden">
                {screen.backgroundImageUrl ? (
                    <div
                        ...
                        style={{
                            aspectRatio: `${screen.aspectRatioWidth ?? 16} / ${screen.aspectRatioHeight ?? 9}`,
                        }}
                    >
                        <img
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-border">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                {['デジタル・サラウンド・サウンド', '高輝度4Kプロジェクター'].map(
                                    (item) => (
                                        <li
                                            key={item}
                                            className="flex items-center gap-2 text-sm text-foreground"
