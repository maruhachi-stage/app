...
export function AppLayout() {
  ...
  if (loading || !staff) return <main className="grid min-h-dvh place-items-center bg-admin-canvas text-sm font-bold text-admin-muted-foreground">認証情報を確認しています…</main>
