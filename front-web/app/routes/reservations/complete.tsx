        ...
        <div className="py-12 text-center">
            ...
            {result ? (
                <div className="rounded-lg border border-border bg-card p-6 text-left mb-6">
                    <p className="text-xs text-muted-foreground text-center">予約番号</p>
                    <p className="mt-1 text-3xl font-bold tracking-widest text-center select-all cursor-pointer">
                        {result.reservationCode}
                    </p>
                    <p className="mt-4 text-xs text-muted-foreground text-center">合計金額</p>
                    <p className="mt-1 text-xl font-bold text-center">
                        {result.totalPrice.toLocaleString()}円
                    </p>
                    {result.qrCodeUrl && (
