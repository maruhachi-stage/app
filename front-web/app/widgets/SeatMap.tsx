...
import { SeatLayoutRenderer, type LayoutPoint } from "~/widgets/seat-map/SeatLayoutRenderer"
import { SeatMapMagnifier } from "~/widgets/seat-map/SeatMapMagnifier"
import { SeatLegend } from "~/widgets/seat-map/SeatLegend"
    ...
    <div className="hidden md:block">
      <div className="mb-3 flex items-center justify-between gap-3">
        <p className="text-[11px] font-bold text-muted-foreground">
          {focusPoint ? "拡大表示はドラッグで移動できます" : "座席以外をクリックすると拡大できます"}
        </p>
      </div>
